...
{
    abstract class BaseDBUtilities
    {
        ...
        #region class protected variables
            protected string conn_string = string.Empty;
            protected string err_msg = string.Empty;
        #endregion

        #region abstract methods
            public abstract bool connect();

            public abstract DataTable get_data_table(string sql_stmt);

            public abstract DataSet get_data_set(string sql_stmt , string name);

            public abstract bool execute_sql_statement(string sql_stmt);

            public abstract string sql_date_format(DateTime value);
        #endregion

        #region non-abstract methods
            public string get_last_err_msg()
            {
                return this.err_msg;
            }
        #endregion
